...
EventType = Enum("Type", "start arrival departure stop")
...
class EventQueue:
    def __init__(self, simulation_time):
        ...
        self.queue.put((simulation_time, Event(EventType.stop, simulation_time, 999)))
