...
class Plotting:
    def __init__(self, l, mu, sim_time, packets, queue_occupation, ser=None):
        self.l = l
        self.mu = mu
    ...
    def plot_system_occupation(self, sim_mean, queue):
    ...
    def plot_batch_means(self, batch_means, intervals):
        ...
        ax.set_ylabel("Mean of packet in the system")
    ...
    def plot_mean_in_time(self, queues):
        ...
        ax.set_ylabel('Mean of packets in the system')
        ax.set_xlabel("simulation time")
